/**
 ...
 created and added to this namespace at runtime, and by defining the `BaseViewClass` property as their desired
 base View class extension.
...
Y.DataTable.BaseCellInlineEditor =  Y.Base.create('inlineeditor',Y.View,[],{
    ...
    events : {
        'input' : {
            'keypress':     '_onKeyPress',  // for key filtering
            'keydown':      '_onKeyDown',        // for direction, ESC
           // 'keyup':        'processKeyUp',
            'click' :       '_onClick',
...
//======================   PRIVATE METHODS   ===========================
    ...
    _setEditorXY: function(e) {
        var newXY = e.newVal;
        //this.get('container').set('xy',newXY);
        //this._inputNode.setXY(newXY);
        //TODO: fix scrolling with inline editing !!
        this.hideEditor();
    },
