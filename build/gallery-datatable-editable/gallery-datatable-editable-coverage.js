...
this._subscrCellEditors.push(
    ...
    _unbindCellEditingListeners: function(){
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_unbindCellEditingListeners", 645);
...
Y.Array.each(this._subscrCellEditors,function(e){
                _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "(anonymous 8)", 647);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 648);
if(e && e.detach) {
                    _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 649);
e.detach();
                }
            });
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 652);
this._subscrCellEditors = null;
    ...
    _bindEditorScroll: function() {
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_bindEditorScroll", 661);
...
this._subscrCellEditorScrolls.push( this._xScrollNode.on('scroll', this._onScrollUpdateCellEditor, this ) );
        ...
        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 666);
if(this._yScroll && this._yScrollNode) {
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 667);
this._subscrCellEditorScrolls.push( this._yScrollNode.on('scroll', this._onScrollUpdateCellEditor, this ) );
    ...
    _onEditableChange: function(o) {
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_onEditableChange", 680);
...
this.bindEditorListeners();
            ...
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 688);
...
this._destroyColumnEditors();
    ...
    _onDefaultEditorChange: function(o) {
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_onDefaultEditorChange", 710);
...
if ( defeditor && defeditor.search(/none/i)===-1 && this.get('editable') ) {
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 715);
this.set('editable',false);
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 716);
this.set('editable',true);
    ...
    _onEditOpenTypeChange: function() {
        ...
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_onEditOpenTypeChange", 727);
...
this.set('editable',true);
    ...
    _buildColumnEditors: function(){
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_buildColumnEditors", 744);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 745);
var cols     = this.get('columns'),
            defEditr = this.get('defaultEditor'),
            edName, colKey, editorInstance;

        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 749);
if( !Y.DataTable.EditorOptions ) {
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 750);
return;
        }

        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 753);
if( this._columnEditors || this._commonEditors ) {
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 754);
this._destroyColumnEditors();
        }

        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 757);
this._commonEditors = {};
        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 758);
this._columnEditors = {};
...
Y.Array.each(cols,function(c){
            _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "(anonymous 9)", 768);
...
edName = c.editor || defEditr;
                ...
                _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 781);
...
editorInstance = this._createCellEditorInstance(edName,c);
                        ...
                        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 797);
...
this._columnEditors[colKey] = edName;
    ...
    _createCellEditorInstance: function(editorName, column) {
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_createCellEditorInstance", 830);
...
if(column.editorConfig.overlayConfig) {
                _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 839);
...
conf_obj.templateObject = Y.merge(conf_obj.templateObject || {}, column.editorConfig.templateObject);
            ...
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 849);
conf_obj.name = editorName;
        }

        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 852);
...
editorInstance = new BaseViewClass(conf_obj);
            ...
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 862);
editorInstance.addTarget(this);
        }

        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 865);
return editorInstance;
    ...
    _destroyColumnEditors: function(){
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_destroyColumnEditors", 873);
...
Y.Array.each(ces,function(ce){
            _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "(anonymous 10)", 879);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 880);
if(ce && ce.destroy) {
              //   ce.destroy();
                _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 882);
...
Y.Array.each( this.get('columns'), function(c){
            _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "(anonymous 11)", 890);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 891);
if(c.editable === undefined || c.editable === true) {
                _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 892);
this._updateEditableColumnCSS(c.key || c.name,false);
    ...
    _getAllCellEditors: function() {
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_getAllCellEditors", 904);
...
Y.Object.each(this._commonEditors,function(ce){
                _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "(anonymous 12)", 908);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 909);
if(ce && ce instanceof Y.View){
                    _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 910);
rtn.push(ce);
                }
            });
        }
...
Y.Object.each(this._columnEditors,function(ce){
                _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "(anonymous 13)", 916);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 917);
if(ce && ce instanceof Y.View){
...
return rtn;
    ...
    _onKeyEsc:  function(e) {
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_onKeyEsc", 931);
...
this.hideCellEditor();
    ...
    _afterEditableSort: function() {
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_afterEditableSort", 944);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 945);
if(this.get('editable')) {
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 946);
this.hideCellEditor();
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 947);
this._updateAllEditableColumnsCSS();
    ...
    _unsetEditor: function(){
        ...
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_unsetEditor", 956);
...
this._openColKey = null;
        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 961);
this._openCell = null;
        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 962);
this._openTd = null;
    },
    ...
    _updateAllEditableColumnsCSS : function() {
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_updateAllEditableColumnsCSS", 970);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 971);
if(this.get('editable')) {
...
Y.Array.each(cols,function(col){
                _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "(anonymous 14)", 974);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 975);
ckey = col.key || col.name;
                _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 976);
if(ckey) {
                    _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 977);
this._updateEditableColumnCSS(ckey, true); //(flag) ? col.editable || true : false);
    ...
    _updateEditableColumnCSS : function(cname,opt) {
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_updateEditableColumnCSS", 992);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 993);
var tbody = this.get('contentBox').one('tbody.'+this.getClassName('data')),
            ...
            tdCol;
        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 997);
...
tdCol = tbody.all('td.'+this.getClassName('col',cname));
        ...
        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1010);
if(tdCol && opt===true) {
...
tdCol.addClass(this._classColEditable);
        } else {_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1012);
if (tdCol) {
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1013);
tdCol.removeClass(this._classColEditable);
    ...
    _handleCellClick:  function(e){
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_handleCellClick", 1023);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1024);
var td = e.currentTarget,
            cn = this.getColumnNameByTd(td);
        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1026);
if (cn && this._openEditor &&  this._openEditor.get('colKey')!==cn) {
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1027);
this.hideCellEditor();
        }
    },
    ...
    _onScrollUpdateCellEditor: function(e) {
        ...
        //
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_onScrollUpdateCellEditor", 1038);
...
this._openEditor.showEditor(this._openTd);
                        ...
                        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1063);
...
xmin = this._xScrollNode.getX();
                _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1076);
...
if(tdxy[0] >= xmin && tdxy[0] <= xmax ) {
                    _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1080);
if(this._openEditor.get('hidden')) {
...
this._openEditor.hideEditor(true);
    ...
    _onKeyDirChange : function(e) {
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_onKeyDirChange", 1110);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1111);
var dir     = e.newVal,
       ...
       _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1118);
this.hideCellEditor();
...
if(circ) {
           ...
           _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1123);
...
ndir = [ -this.data.size()+1, 0];
           } else {_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1129);
if(dir[0] === -1 && recIndex === 0) {
               _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1130);
ndir = [ this.data.size()-1, 0];
           }}}}

           _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1133);
if(ndir) {
               _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1134);
dir = ndir;
           }
...
this.openCellEditor(newTd);
    ...
    _onCellEditorCancel: function(ev){
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_onCellEditorCancel", 1156);
...
ev.colKey = cell.colKey || this._openColKey;
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1162);
...
ev.halt();
    ...
    _afterCellEditorCancel: function(){
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_afterCellEditorCancel", 1174);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1175);
if(!this._openEditor.get('hidden')) {
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1176);
this.hideCellEditor();
        }
    },
    ...
    _onCellEditorSave: function (ev) {
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_onCellEditorSave", 1208);
...
if(cell && this._openRecord && this._openColKey) {
            ...
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1212);
ev.record = this.data.getByClientId(cell.recClientId) || this._openRecord;
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1213);
ev.colKey = cell.colKey || this._openColKey;
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1214);
ev.editorName = this._openEditor.get('name');
        } else {
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1216);
ev.halt();
        }
    ...
    _afterCellEditorSave: function (ev) {
        _yuitest_coverfunc("build/gallery-datatable-editable/gallery-datatable-editable.js", "_afterCellEditorSave", 1227);
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1228);
if(ev.record){
            _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1229);
ev.record.set(ev.colKey, ev.newValue);
        }

        _yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1232);
this.hideCellEditor();
    }
...
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1251);
Y.DataTable.Editable = DtEditable;
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1252);
 ...
 * @since 3.8.0
 */
_yuitest_coverline("build/gallery-datatable-editable/gallery-datatable-editable.js", 1266);
