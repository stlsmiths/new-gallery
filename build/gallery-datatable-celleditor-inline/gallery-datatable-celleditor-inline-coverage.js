...
this._subscr = null;
    ...
    _defEditorSaveFn: function(e){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_defEditorSaveFn", 216);
...
this.hideEditor();
    ...
    _defEditorCancelFn: function(){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_defEditorCancelFn", 226);
...
this.hideEditor();
    ...
    _defEditorShowFn: function (ev) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_defEditorShowFn", 232);
...
var cell = this.get('cell'),
        ...
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 277);
prepfn = this.get('prepFn');
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 278);
val = (prepfn && prepfn.call) ? prepfn.call(this,val) : val;


        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 281);
this.fire('editorShow',{
    ...
    saveEditor: function(val){
        ...
        //
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "saveEditor", 316);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 320);
...
var savefn = this.get('saveFn') ;
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 324);
...
this.fire("editorCancel",{
    ...
    processKeyPress: function(e) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "processKeyPress", 409);
...
var keyc    = e.keyCode,
        ...
        //
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 422);
if(keyc === KEYC_RTN) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 423);
e.preventDefault();
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 424);
...
flagRE = (!kchar.match(keyfilt)) ? false : flagRE;
        } else {_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 432);
if (Y.Lang.isFunction(keyfilt)) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 433);
krtn = keyfilt.call(this,e);
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 434);
...
if(!flagRE) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 439);
e.preventDefault();
        }
    ...
    processKeyDown : function(e){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "processKeyDown", 454);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 455);
var keyc    = e.keyCode,
            dir;

        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 458);
switch(keyc) {

            case KEYC_ESC:
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 461);
e.preventDefault();
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 462);
this.hideEditor();
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 463);
break;
...
dir = (e.ctrlKey) ? [1,0] : null;
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 471);
break;
...
dir = (e.ctrlKey) ? [0,-1] : null;
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 475);
break;

            case KEYC_RIGHT:
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 478);
dir = (e.ctrlKey) ? [0,1] : null;
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 479);
break;
...
if(dir) {
            ...
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 491);
if(this.get('inputKeys')===true) {
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 492);
