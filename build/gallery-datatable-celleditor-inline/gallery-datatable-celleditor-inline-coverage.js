...
//======================   PRIVATE METHODS   ===========================
     ...
     */
    _createUI: function() {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_createUI", 507);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 508);
var container = this.get('container'),
            html      = Y.Lang.sub(this.template, {cssInput:this._cssInput});

        // set the View container contents
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 512);
...
if (!container.inDoc()) {
          _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 516);
...
container.setStyle('zIndex',999);
        ...
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 521);
container.hide();

        // set a static placeholder for the input ...
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 524);
...
this._inputNode.addClass(this.get('className'));
        ...
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 529);
this.fire('editorCreated',{
            inputNode:  this._inputNode,
            container:  container
        });
    ...
    _resizeCont: function(cont,td) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_resizeCont", 556);
...
h += pt;
        ...
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 567);
cont.setStyle('width',w+'px');
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 568);
cont.setStyle('height',h+'px');
    ...
    _parseStyle: function(el,v) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_parseStyle", 580);
...
return +(el.getComputedStyle(v).replace(/px/,''));
     ...
     */
    _onClick: function(o) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_onClick", 591);
...
o.stopPropagation();
    ...
    _onMouseLeave : function() {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_onMouseLeave", 600);
...
if(this.get('hideMouseLeave')){
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 602);
this.hideEditor();
        }
    },
    ...
    _setEditorXY: function() {
        ...
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_setEditorXY", 616);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 623);
this.hideEditor();
    }
    ...
    ATTRS:{
        ...
        hostDT : {
            value:  null,
            validator:  function(v) { _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "validator", 682);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 682);
...
@public
**/
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 913);
Y.DataTable.EditorOptions.inline = {
    BaseViewClass:  Y.DataTable.BaseCellInlineEditor,
    name:           'inline'
};
...
@public
**/
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 972);
Y.DataTable.EditorOptions.inlineNumber = {
    BaseViewClass:  Y.DataTable.BaseCellInlineEditor,
    name:           'inlineNumber',
    hideMouseLeave: false,
    ...
    //       and converts the value to numeric (or undefined if fails regexp);
    saveFn: function(v){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "saveFn", 994);
...
var vre = this.get('validator'),
            value;
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 997);
if(vre instanceof RegExp) {
...
value = +v;
        ...
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1002);
return value;
    }
...
@public
**/
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1059);
Y.DataTable.EditorOptions.inlineDate = {
    BaseViewClass:  Y.DataTable.BaseCellInlineEditor,
    name:           'inlineDate',
    ...
    //   so we pre-format the textbox in "human readable" format here
    prepFn: function(v){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "prepFn", 1078);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1079);
var dfmt =  this.get('dateFormat') || "%m/%d/%Y";
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1080);
return Y.DataType.Date.format(v,{format:dfmt});
    },
    ...
    //  i.e. converts back to "Date" format that DT expects ...
    saveFn: function(v){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "saveFn", 1085);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1086);
...
@public
**/
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1167);
Y.DataTable.EditorOptions.inlineAC = {
    BaseViewClass:  Y.DataTable.BaseCellInlineEditor,
    name:           'inlineAC',
    hideMouseLeave: false,
    ...
    after: {
       ...
       //---------
       editorCreated : function(o){
           _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "editorCreated", 1193);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1194);
var inputNode = o.inputNode,
               // Get the users's editorConfig "autocompleteConfig" settings
               acConfig = this.get('autocompleteConfig') || {},
               editor = this;
...
if(inputNode && Y.Plugin.AutoComplete) {
               // merge user settings with these required settings ...
               _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1201);
acConfig = Y.merge(acConfig,{
                   alwaysShowList: true,
                   render: true
               });
               // plug in the autocomplete and we're done ...
               _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1206);
inputNode.plug(Y.Plugin.AutoComplete, acConfig);

               // add this View class as a static prop on the ac plugin
               _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1209);
inputNode.ac.editor = editor;
           }
