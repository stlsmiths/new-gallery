...
val = (savefn && savefn.call) ? savefn.call(this,val) : val;
            ...
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 326);
if(val === undefined) {
...
//======================   PRIVATE METHODS   ===========================
     ...
     */
    _createUI: function() {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_createUI", 416);
...
if (!container.inDoc()) {
          _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 425);
...
if(this.get('className')) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 435);
this._inputNode.addClass(this.get('className'));
        }
...
this.fire('editorCreated',{
    ...
    _resizeCont: function(cont,td) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_resizeCont", 465);
...
h += pt;
        ...
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 476);
...
cont.setStyle('height',h+'px');
    ...
    _parseStyle: function(el,v) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_parseStyle", 489);
...
return +(el.getComputedStyle(v).replace(/px/,''));
     ...
     */
    _onClick: function(o) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_onClick", 500);
...
o.stopPropagation();
    ...
    _onMouseLeave : function() {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_onMouseLeave", 509);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 510);
if(this.get('hideMouseLeave')){
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 511);
this.hideEditor();
        }
    },
    ...
    _setEditorXY: function() {
        ...
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_setEditorXY", 525);
...
this.hideEditor();
    ...
    _onKeyPress: function(e) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_onKeyPress", 543);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 544);
var keyc    = e.keyCode,
        ...
        //
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 556);
if(keyc === KEYC_RTN) {
...
flagRE = (!kchar.match(keyfilt)) ? false : flagRE;
        } else {_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 566);
...
if(!flagRE) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 573);
e.preventDefault();
        }
    ...
    _onKeyDown : function(e){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_onKeyDown", 587);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 588);
var keyc    = e.keyCode,
            dir;

        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 591);
switch(keyc) {

            case KEYC_ESC:
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 594);
e.preventDefault();
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 595);
this.hideEditor();
...
break;
            ...
            case KEYC_DOWN:
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 603);
dir = (e.ctrlKey) ? [1,0] : null;
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 604);
break;

            case KEYC_LEFT:
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 607);
...
break;
            ...
            case KEYC_RIGHT:
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 611);
dir = (e.ctrlKey) ? [0,1] : null;
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 612);
break;
...
dir = (e.shiftKey) ? [0,-1] : [0,1] ;
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 616);
break;
        }
        ...
        //
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 622);
if(dir) {
            // set the key direction movement
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 624);
if(this.get('inputKeys')===true) {
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 625);
this._set('keyDir',dir);
            }
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 627);
e.preventDefault();
        }
    ...
    ATTRS:{
        ...
        hostDT : {
            value:  null,
            validator:  function(v) { _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "validator", 687);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 687);
...
@public
**/
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 918);
Y.DataTable.EditorOptions.inline = {
    BaseViewClass:  Y.DataTable.BaseCellInlineEditor,
    name:           'inline'
};
...
@public
**/
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 977);
Y.DataTable.EditorOptions.inlineNumber = {
    BaseViewClass:  Y.DataTable.BaseCellInlineEditor,
    name:           'inlineNumber',
    hideMouseLeave: false,
    ...
    //       and converts the value to numeric (or undefined if fails regexp);
    saveFn: function(v){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "saveFn", 999);
...
if(vre instanceof RegExp) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1003);
value = (vre.test(v)) ? +v : undefined;
        } else {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1005);
value = +v;
        }
...
@public
**/
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1064);
Y.DataTable.EditorOptions.inlineDate = {
    BaseViewClass:  Y.DataTable.BaseCellInlineEditor,
    name:           'inlineDate',
    ...
    //   so we pre-format the textbox in "human readable" format here
    prepFn: function(v){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "prepFn", 1083);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1084);
var dfmt =  this.get('dateFormat') || "%m/%d/%Y";
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1085);
return Y.DataType.Date.format(v,{format:dfmt});
    },
    ...
    //  i.e. converts back to "Date" format that DT expects ...
    saveFn: function(v){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "saveFn", 1090);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1091);
...
@public
**/
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1172);
Y.DataTable.EditorOptions.inlineAC = {
    BaseViewClass:  Y.DataTable.BaseCellInlineEditor,
    name:           'inlineAC',
    hideMouseLeave: false,
    ...
    after: {
       ...
       //---------
       editorCreated : function(o){
           _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "editorCreated", 1198);
...
acConfig = Y.merge(acConfig,{
               ...
               // plug in the autocomplete and we're done ...
               _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1211);
inputNode.plug(Y.Plugin.AutoComplete, acConfig);

               // add this View class as a static prop on the ac plugin
               _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1214);
inputNode.ac.editor = editor;
           }
