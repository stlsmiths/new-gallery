...
this._subscr = [];
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 194);
this._subscr.push( this.on('xyChange',this._setEditorXY) );
     ...
     */
    _unbindUI: function(){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_unbindUI", 202);
...
Y.Array.each(this._subscr,function(e){
            _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "(anonymous 2)", 203);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 204);
if(e && e.detach) {
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 205);
e.detach();
            }
        });
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 208);
this._subscr = null;
    },
    ...
    _defEditorSaveFn: function(e){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_defEditorSaveFn", 217);
...
this.set('value', e.newValue);
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 219);
this.hideEditor();
    },
    ...
    _defEditorCancelFn: function(){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_defEditorCancelFn", 227);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 228);
this.hideEditor();
    },
...
//======================   PUBLIC METHODS   ===========================
    ...
    showEditor: function(td) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "showEditor", 243);
...
xy = td.getXY();
        ...
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 256);
cont.show();
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 257);
this._resizeCont(cont,td);
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 258);
cont.setXY(xy);

        // focus the inner INPUT ...
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 261);
this._inputNode.focus();

        // if there is a "prep" function ... call it to pre-process the editing
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 264);
prepfn = this.get('prepFn');
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 265);
val = (prepfn && prepfn.call) ? prepfn.call(this,val) : val;

        // set the INPUT value
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 268);
this._inputNode.set('value',val);
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 269);
this.set('lastValue',val);

        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 271);
this._set('visible',true);
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 272);
this._set('hidden',false);

        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 274);
this.fire('editorShow',{
    ...
    saveEditor: function(val){
        ...
        //
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "saveEditor", 309);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 313);
if( val !== undefined && val !== null ){

            // If a "save" function was defined, run thru it and update the "value" setting
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 316);
var savefn = this.get('saveFn') ;
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 317);
val = (savefn && savefn.call) ? savefn.call(this,val) : val;

            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 319);
if(val === undefined) {
...
return;
            ...
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 325);
this.fire("editorSave",{
    ...
    hideEditor: function(hideMe){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "hideEditor", 357);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 358);
var cont  = this.get('container');
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 359);
if(cont && cont.hide) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 360);
cont.hide();
        }
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 362);
if(hideMe===true) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 363);
...
this.fire('editorHide');
    ...
    cancelEditor: function(){
      //  this.hideEditor();
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "cancelEditor", 383);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 385);
...
//======================   PRIVATE METHODS   ===========================
     ...
     */
    _createUI: function() {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_createUI", 409);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 410);
var container = this.get('container'),
            html      = Y.Lang.sub(this.template, {cssInput:this._cssInput});

        // set the View container contents
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 414);
...
if (!container.inDoc()) {
          _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 418);
Y.one('body').append(container);
        }

        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 421);
container.setStyle('zIndex',999);

        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 423);
container.hide();

        // set a static placeholder for the input ...
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 426);
this._inputNode = container.one('input');
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 427);
if(this.get('className')) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 428);
this._inputNode.addClass(this.get('className'));
        }
...
this.fire('editorCreated',{
    ...
    _resizeCont: function(cont,td) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_resizeCont", 458);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 459);
var w   = this._parseStyle(td,'width'),
        ...
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 466);
w += pl + blw - 1;
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 467);
h += pt;
...
cont.setStyle('height',h+'px');
    ...
    _parseStyle: function(el,v) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_parseStyle", 482);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 483);
return +(el.getComputedStyle(v).replace(/px/,''));
     ...
     */
    _onClick: function(o) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_onClick", 493);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 494);
o.stopPropagation();
    },
    ...
    _onMouseLeave : function() {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_onMouseLeave", 502);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 503);
if(this.get('hideMouseLeave')){
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 504);
this.hideEditor();
        }
    },
    ...
    _setEditorXY: function() {
        ...
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_setEditorXY", 518);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 525);
this.hideEditor();
    },
    ...
    _onKeyPress: function(e) {
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_onKeyPress", 536);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 537);
var keyc    = e.keyCode,
        ...
        //
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 549);
if(keyc === KEYC_RTN) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 550);
e.preventDefault();
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 551);
this.saveEditor(value);
        ...
        //
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 557);
if(keyfilt instanceof RegExp) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 558);
flagRE = (!kchar.match(keyfilt)) ? false : flagRE;
        } else {_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 559);
if (Y.Lang.isFunction(keyfilt)) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 560);
krtn = keyfilt.call(this,e);
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 561);
flagRE = (krtn) ? true : false;
        }}

        // If key filtering returned false, prevent continuing
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 565);
if(!flagRE) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 566);
e.preventDefault();
        }
    ...
    _onKeyDown : function(e){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "_onKeyDown", 580);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 581);
var keyc    = e.keyCode,
            dir;

        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 584);
switch(keyc) {

            case KEYC_ESC:
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 587);
e.preventDefault();
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 588);
this.hideEditor();
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 589);
break;

            case KEYC_UP:
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 592);
dir = (e.ctrlKey) ? [-1,0] : null;
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 593);
break;

            case KEYC_DOWN:
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 596);
dir = (e.ctrlKey) ? [1,0] : null;
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 597);
break;

            case KEYC_LEFT:
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 600);
dir = (e.ctrlKey) ? [0,-1] : null;
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 601);
break;

            case KEYC_RIGHT:
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 604);
dir = (e.ctrlKey) ? [0,1] : null;
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 605);
break;
...
break;
        ...
        //
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 615);
if(dir) {
            // set the key direction movement
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 617);
if(this.get('inputKeys')===true) {
                _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 618);
this._set('keyDir',dir);
            }
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 620);
e.preventDefault();
        }
    ...
    ATTRS:{
        ...
        hostDT : {
            value:  null,
            validator:  function(v) { _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "validator", 680);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 680);
...
@public
**/
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 911);
Y.DataTable.EditorOptions.inline = {
    BaseViewClass:  Y.DataTable.BaseCellInlineEditor,
    name:           'inline'
};
...
@public
**/
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 970);
Y.DataTable.EditorOptions.inlineNumber = {
    BaseViewClass:  Y.DataTable.BaseCellInlineEditor,
    name:           'inlineNumber',
    hideMouseLeave: false,
    ...
    //       and converts the value to numeric (or undefined if fails regexp);
    saveFn: function(v){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "saveFn", 992);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 993);
var vre = this.get('validator'),
            value;
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 995);
if(vre instanceof RegExp) {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 996);
value = (vre.test(v)) ? +v : undefined;
        } else {
            _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 998);
value = +v;
        }
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1000);
return value;
    }
...
@public
**/
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1057);
Y.DataTable.EditorOptions.inlineDate = {
    BaseViewClass:  Y.DataTable.BaseCellInlineEditor,
    name:           'inlineDate',
    ...
    //   so we pre-format the textbox in "human readable" format here
    prepFn: function(v){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "prepFn", 1076);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1077);
var dfmt =  this.get('dateFormat') || "%m/%d/%Y";
        _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1078);
return Y.DataType.Date.format(v,{format:dfmt});
    },
    ...
    //  i.e. converts back to "Date" format that DT expects ...
    saveFn: function(v){
        _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "saveFn", 1083);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1084);
...
@public
**/
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1165);
Y.DataTable.EditorOptions.inlineAC = {
    BaseViewClass:  Y.DataTable.BaseCellInlineEditor,
    name:           'inlineAC',
    hideMouseLeave: false,
    ...
    after: {
       ...
       //---------
       editorCreated : function(o){
           _yuitest_coverfunc("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", "editorCreated", 1191);
_yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1192);
var inputNode = o.inputNode,
               // Get the users's editorConfig "autocompleteConfig" settings
               acConfig = this.get('autocompleteConfig') || {},
               editor = this;

           _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1197);
if(inputNode && Y.Plugin.AutoComplete) {
               // merge user settings with these required settings ...
               _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1199);
acConfig = Y.merge(acConfig,{
                   alwaysShowList: true,
                   render: true
               });
               // plug in the autocomplete and we're done ...
               _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1204);
inputNode.plug(Y.Plugin.AutoComplete, acConfig);

               // add this View class as a static prop on the ac plugin
               _yuitest_coverline("build/gallery-datatable-celleditor-inline/gallery-datatable-celleditor-inline.js", 1207);
inputNode.ac.editor = editor;
           }
